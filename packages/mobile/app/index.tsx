...
const discovery = {
  ...
  revocationEndpoint:
    "https://github.com/settings/connections/applications/8d03a95443f3acf7b8e7",
};
...
export default function App() {
  ...
  return (
    <>
      ...
      <StatusBar translucent networkActivityIndicatorVisible />
    </>
  );
}
